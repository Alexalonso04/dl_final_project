...
#-----------------------------------------------------------------------------------------------------------------------
data_set = "allenai/ai2_arc"

df = load_dataset(data_set, "ARC-Challenge", cache_dir="./cache", trust_remote_code=True)
...
def preprocess_data(examples):
    ...
    # this mapping needs to be looked into for the 'E' when I ran a sql distinct query on hugging face I did not see 'E'
    answer_key_mapping = {'A': 0, 'B': 1, 'C': 2, 'D': 3, '1': 1, '2': 2, '3': 3, '4': 4, 'E': 4}
